...
from mtdctk import (DATE, VERSION, TEMPLATE_FINAL_COLUMNS, VALID_FASTQ_TYPES,
                    VALID_TREATMENTS, MTD_CT_Exception, program_header, 
...
def check_directories_are_not_identical(input_dir, output_dir):
    ...
    if same_dir == True:
        raise MTD_CT_Exception('Error! The provided Input and Output directories are the same!')
