...
from mtdctk import (DATE, VERSION, program_header, MTD_CT_Exception,
...
def check_generic_run(run_object, output_dir, expected_files, n_elements, color_treatment):
    ...
    if run_object.returncode != 0:
        raise MTD_CT_Exception('Error! Running the program returned an exit code different than 0!')
    else:
        #List output_dir
...
def copy_file(file_name, input_file_path, output_directory_path):
    ...
    try:
        ...
        raise MTD_CT_Exception('Error! This file could not be successfully copied in the Output Directory!')
...
def read_reference_log_file(input_file_path):
    ...
    try:
        ...
        raise MTD_CT_Exception('Error! The reference log file could not be successfully read!')
...
def save_log_file(content, output_file_path):
    ...
    try:
        ...
        raise MTD_CT_Exception('Error! The log file could not be successfully saved!')
...
def create_subdirectory(subdir_name, output_directory_path):
    ...
    try:
        ...
        raise MTD_CT_Exception('Error! The subdirectory could not be successfully created!')
